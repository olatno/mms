      ...
      <div class="profile_box">
        <div class="profile_top_curve">
          <div class="profile_detail_content">
            <div id="left_container_inner"><img src="images/ico-terms.png" alt="" width="164" height="150" style="padding:40px 0 0 40px" /> </div>
            <div id="right_container_inner">
              <div style="font-family:arial; padding:20px 0 0 20px"><strong><font size="+3">Privacy Policy</font><br />
                <br />
